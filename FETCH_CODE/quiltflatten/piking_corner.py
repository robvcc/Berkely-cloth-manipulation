...
if __name__ == '__main__':
    ...
    position = [0.7788437979162758, 0.3, 0.8033053490563912]
    ...
    position = [0.7388437979162758, 0.3, 1.3133053490563912]
    fetch_client.move_to_position_up(position)

    position = [0.7388437979162758, -0.2, 0.8133053490563912]
